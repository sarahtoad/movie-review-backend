...
import { getProfileByUsername, updateProfile } from "./user.service";
...
export async function getProfile(
  ...
  res.json(await getProfileByUsername(username));
...
export async function patchProfile(
  ...
  try {
    ...
    const user = await updateProfile(req.user!.id, updatePayload);
